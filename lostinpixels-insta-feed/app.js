const s = (sketch) => {
    ...
    function drawFeed() {
        ...
        images.forEach((imageData, imageIndex) => {
            ...
            sketch.noStroke();
            var nothing = 0;
            var dif = sketch.max(0, 18 - imageData.timeAgo);
                    ...
                    if (typeof imageData.img.pixels[index + (imageData.img.width * 4)] === 'number') {
                        ...
                        if (imageData.timeAgo > 2) {
                            ...
                            if (hsp1 > hsp2) {
                                ...
                                imageData.img.pixels[index + (imageData.img.width * 4)] = store[0] - sketch.round(imageData.timeAgo / 10);
                                imageData.img.pixels[index + 1 + (imageData.img.width * 4)] = store[1] - sketch.round(imageData.timeAgo / 10);
                                imageData.img.pixels[index + 2 + (imageData.img.width * 4)] = store[2] - sketch.round(imageData.timeAgo / 10);
                            } else {
                                nothing++;
